-- =====================================================
-- MINISTÉRIO DO BLOCO - PHASE 3 MIGRATION
...
-- Advanced indexes for events_new
...
CREATE INDEX IF NOT EXISTS idx_events_future ON events_new(start_datetime) WHERE start_datetime > NOW();
